  ...
  return (
    <>
      ...
      <ScrollView style={{width: '100%' , flex:1 , display:'flex',
        ...
        <View style={{backgroundColor: theme.card, width: '100%',}}>
          ...
          <View style={{display:'flex', flexDirection:'column', justifyContent:'flex-start', paddingHorizontal: 16, paddingVertical: 12}}>
            <View style={{display:'flex', flexDirection:'row', justifyContent:'space-between', alignItems: 'flex-start', marginBottom: 12}}>
              <View>
              <Text style={{fontSize: 20, fontFamily: 'Inter_500Medium', letterSpacing: 20 * (-5 / 100), color: theme.text}}>{clampChars(title)}</Text>
              <Text style={{fontSize: 14, marginLeft: 1, fontFamily: 'Inter_300Light', letterSpacing: 14 * (-5 / 100), color: theme.text}}>{sector}</Text>
              </View>
            ...
            <View style={{display:'flex', flexDirection:'column', marginBottom: 16}}>
              <Text style={{fontFamily:'Inter_600SemiBold', color: theme.alt, fontSize: 16, letterSpacing: 12 * (-5 / 100), marginBottom: 4}}>Target Audience</Text>
              <Text style={{fontFamily:'Inter_300Light', color: theme.alt, fontSize: 12}}>{target}</Text>
            </View>
            <View style={{display:'flex', flexDirection:'column', marginBottom: 16}}>
              <Text style={{fontFamily:'Inter_600SemiBold', color: theme.alt, fontSize: 16, letterSpacing: 12 * (-5 / 100), marginBottom: 4}}>Amount</Text>
              <Text style={{fontFamily:'Inter_300Light', color: theme.alt, fontSize: 12}}>{amount}</Text>
            </View>
            <View style={{display:'flex', flexDirection:'column', marginBottom: 16}}>
              <Text style={{fontFamily:'Inter_600SemiBold', color: theme.alt, fontSize: 16, letterSpacing: 12 * (-5 / 100), marginBottom: 4}}>Provisions</Text>
              <Text style={{fontFamily:'Inter_300Light', color: theme.alt, fontSize: 12}}>{provision}</Text>
            </View>
            <View style={{display:'flex', flexDirection:'column', marginBottom: 16}}>
              <Text style={{fontFamily:'Inter_600SemiBold', color: theme.alt, fontSize: 16, letterSpacing: 12 * (-5 / 100), marginBottom: 4}}>Requirements</Text>
              {requirements ? requirements.map((item, index) => <View key={index} style={{display:'flex', flexDirection:'row', alignItems: 'center', marginBottom: 4}}>
                              ...
                              <Text style={{fontFamily:'Inter_300Light', color: theme.alt, fontSize: 12}}>{item}</Text>
              </View>) : null}
            </View>
            <View style={{display:'flex', flexDirection:'column', marginBottom: 24}}>
              <Text style={{fontFamily:'Inter_600SemiBold', color: theme.alt, fontSize: 16, letterSpacing: 12 * (-5 / 100), marginBottom: 4}}>Application Process</Text>
              <Text style={{fontFamily:'Inter_300Light', color: theme.alt, fontSize: 12}}>{process}</Text>
            </View>
